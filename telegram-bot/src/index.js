...
import { handleNaturalLanguage } from './handlers/chat.js';
import { pollScheduledJobResults } from './handlers/schedule.js';
import { 
  handleCancelSeries, 
  handleSeriesStatus, 
  handleMySeries 
} from './handlers/recurring.js';
import { handleCallbackQueryListener } from './handlers/interactive.js';
...
bot.onText(/\/(start|help)/, (msg) => setImmediate(() => handleHelp(bot, msg)));
